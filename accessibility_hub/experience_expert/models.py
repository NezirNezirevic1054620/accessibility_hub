...
voorkeur_keuzes = (("telefonisch", "telefonisch"), ("email", "email"))
...
class ExperienceExpert(models.Model):
    ...
    naam_voogd_toezichthouder = models.CharField(max_length=255, null=True)
    email_voogd_toezichthouder = models.EmailField(max_length=255, null=True)
    tel_voogd_toezichthouder = models.CharField(max_length=255, null=True)
